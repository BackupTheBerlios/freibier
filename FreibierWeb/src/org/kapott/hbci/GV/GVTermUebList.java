...
/*  $Id: GVTermUebList.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
    ...
    extends HBCIJobImpl
{
    ...
    {
        super(getLowlevelName(),passport,new GVRTermUebList());
    ...
    protected void extractResults(Properties result,String header,int idx)
    {
        ...
        entry.date=HBCIUtils.string2Date(result.getProperty(header+".date"));
