/*  $Id: HBCIJob.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
...
/** <p>Schnittstelle für alle Aufträge, die via HBCI ausgeführt werden sollen. Ein
 ...
 hinzugefügt werden 
 ({@link org.kapott.hbci.manager.HBCIHandler#addJob(org.kapott.hbci.GV.HBCIJob)}).</p>
...
public interface HBCIJob
{
     ...
     *  {@link org.kapott.hbci.manager.HBCIHandler#addJob(HBCIJob)}
