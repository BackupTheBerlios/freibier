...
/*  $Id: INILetter.java,v 1.1 2005/04/05 21:34:48 tbayen Exp $
...
/** <p>Tool zum Erzeugen eines INI-Briefes. Diese Klasse enthält kein Programmier-API,
    ...
    ein <code>RDHNew</code>-, ein <code>SIZRDHFile</code>- oder ein <code>OpenHBCI</code>-Passport-Format handelt. 
...
public final class INILetter
{
    ...
    public static void main(String[] args)
        throws IOException
    {
        String rdhtype=getArg(args,0,"Passport-Typ (RDH, RDHNew, SIZRDHFile oder OpenHBCI)");
        ...
        } else if (rdhtype.equals("OpenHBCI")) {
            String datafile=getArg(args,3,"Dateiname der OpenHBCI-Init-Datei (.openhbci im Homedirectory)");
            HBCIUtils.setParam(header+".mediafile",pfilename);
            HBCIUtils.setParam(header+".datafile",datafile);
        }
