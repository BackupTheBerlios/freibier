...
/*  $Id: AbstractShowLowlevelData.java,v 1.1 2005/04/05 21:34:48 tbayen Exp $
        ...
        for (int i=0;i<len;i++) {
            ...
            if (contentref.getNodeType()==Node.ELEMENT_NODE) {
                if (first) {
                    ...
                    displayContentRef("",(Element)contentref,syntax,2);
                }
            }
        }
    }
    
    protected static void displayContentRef(String path,Element ref,Document syntax,int indent)
    {
            ...
            if (ref.getNodeName().equals("DE")) {
                ...
                for (int i=0;i<len;i++) {
                    ...
                    if (content.getNodeType()==Node.ELEMENT_NODE)
                        displayContentRef(pathWithDot(path)+name,(Element)content,syntax,indent+2);
                }
            }
        }
    }
