...
/*  $Id: DTAUS_CH.java,v 1.1 2005/04/05 21:34:48 tbayen Exp $
...
public class DTAUS_CH
{
    public class Transaction
    {
        ...
        public String toString()
        {
            ...
            ret.append(value.curr);
            ret.append(expand(new DecimalFormat("0.00").format(value.value).replace('.',','),12,(byte)0x20,ALIGN_LEFT));
            total+=value.value*1000;
    ...
    public String toString()
    {
        ...
        ret.append(expand(new DecimalFormat("0.000").format(total/1000.0).replace('.',','),16,(byte)0x20,ALIGN_LEFT));
