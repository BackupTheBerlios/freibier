...
/*  $Id: GVRDauerList.java,v 1.1 2005/04/05 21:34:46 tbayen Exp $
    ...
    extends HBCIJobResultImpl
{
    ...
    public static final class Dauer
    {
        ...
        /** Geänderte Währung während Aussetzung (Nur gültig, wenn <code>aus_available</code> <code>true</code> ist) (optional) */
        ...
        public String toString()
        {
            ...
            ret.append("  "+HBCIUtilsInternal.getLocMsg("SRCACCOUNT")+": "+my.toString()+linesep);
            ret.append("  "+HBCIUtilsInternal.getLocMsg("DSTACCOUNT")+": "+other.toString()+linesep);
            ret.append("  "+HBCIUtilsInternal.getLocMsg("VALUE")+": "+value.toString()+linesep);
            ret.append("  "+HBCIUtilsInternal.getLocMsg("KEY")+": "+key+"/"+addkey+linesep);
            ret.append("  "+HBCIUtilsInternal.getLocMsg("USAGE")+":"+linesep);
            for (int i=0;i<usage.length;i++) {
                ret.append("    "+usage[i]+linesep);
            }
            if (nextdate!=null)
                ret.append("  "+HBCIUtilsInternal.getLocMsg("NEXTEXECDATE")+": "+HBCIUtils.date2String(nextdate)+linesep);
            ret.append("  "+HBCIUtilsInternal.getLocMsg("ORDERID")+": "+orderid+linesep);

            ret.append("  "+HBCIUtilsInternal.getLocMsg("FIRSTLASTEXEC")+": "+HBCIUtils.date2String(firstdate)+" / "+
                    (lastdate!=null?HBCIUtils.date2String(lastdate):"N/A")+linesep);
                    ret.append("  "+HBCIUtilsInternal.getLocMsg("EXECDAY")+": "+execday+linesep);
            ret.append("  "+HBCIUtilsInternal.getLocMsg("UNITTURNUS")+": "+timeunit+" / "+turnus+linesep);
    ...
    {
        return (Dauer[])entries.toArray(new Dauer[0]);
    }
    ...
    public String toString()
    {
        ...
        for (Iterator i=entries.iterator();i.hasNext();) {
            ret.append(HBCIUtilsInternal.getLocMsg("STANDINGORDER")+" #"+i+System.getProperty("line.separator"));
            ret.append(i.next()+System.getProperty("line.separator"));
        }
