...
/*  $Id: GVRFestCondList.java,v 1.1 2005/04/05 21:34:46 tbayen Exp $
    ...
    extends HBCIJobResultImpl
{
    ...
    public static final class Cond
    {
        ...
        public String toString()
        {
            ...
            ret.append("Konditionen '"+name+"'");
            if (version!=null)
                ret.append(" V"+version+" "+HBCIUtils.date2String(date)+" "+HBCIUtils.time2String(date));
            ret.append(linesep);
            
            ret.append("  Zeitraum: ");
            ret.append(HBCIUtils.date2String(anlagedatum));
            ret.append(" bis ");
            ret.append(HBCIUtils.date2String(ablaufdatum));
            ret.append(linesep);
            ...
            ret.append("  Zinssatz: ");
            ret.append(HBCIUtilsInternal.double2String(zinssatz));
            ret.append("% (");
            switch (zinsmethode) {
    ...
    {
        return (Cond[])entries.toArray(new Cond[0]);
    }
