...
/*  $Id: GVRInfoOrder.java,v 1.1 2005/04/05 21:34:46 tbayen Exp $
    ...
    extends HBCIJobResultImpl
{
    ...
    {
        return (Info[])infos.toArray(new Info[0]);
    }
    ...
    public String toString()
    {
        ...
        for (int i=0;i<infos.size();i++) {
            ret.append(((Info)infos.get(i)).toString()+System.getProperty("line.separator"));
        }
