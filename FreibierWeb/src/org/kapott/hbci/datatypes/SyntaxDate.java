...
/*  $Id: SyntaxDate.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
    ...
    extends SyntaxDE
{
    ...
    */
    ...
    {
        return new SimpleDateFormat("yyyyMMdd").format(HBCIUtils.string2Date(x));
    }
    ...
    {
        try {
            return HBCIUtils.date2String(new SimpleDateFormat("yyyyMMdd").parse(x));
        } catch (Exception e) {
