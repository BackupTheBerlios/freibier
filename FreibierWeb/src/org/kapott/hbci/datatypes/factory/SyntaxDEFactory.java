...
/*  $Id: SyntaxDEFactory.java,v 1.1 2005/04/05 21:34:48 tbayen Exp $
...
public class SyntaxDEFactory 
{
    ...
    {
        SyntaxDE ret=null;
        ObjectFactory factory=(ObjectFactory)factories.get(dataType);
        
        if (factory==null) {
            factory=new ObjectFactory();
            factory.maxPoolSize=Integer.parseInt(HBCIUtils.getParam("kernel.objpool.Syntax","1024"));
            factories.put(dataType,factory);
        }
        
        if (factory.getFreeObjects().isEmpty()) {
            ...
            try {
                ...
                throw new InitializingException((Exception)e.getTargetException(),path);
            }
    ...
    public String toString()
    {
        ...
        for (Enumeration e=factories.keys();e.hasMoreElements();) {
            ...
            ret.append(type+": "+fac.toString()+System.getProperty("line.separator"));
        }
