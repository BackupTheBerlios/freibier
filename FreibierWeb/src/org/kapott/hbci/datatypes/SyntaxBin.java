...
/*  $Id: SyntaxBin.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
    ...
    */
    private static String expand(String x)
    {
        ...
        case 'B':
            ...
            break;
        default:
            throw new InvalidArgumentException(HBCIUtilsInternal.getLocMsg("EXC_DTBIN_NO_VALID_FORMAT",
                                                                   new Object[] {"B or N",Character.toString(format)}));
        }
