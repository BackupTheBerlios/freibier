...
/*  $Id: SyntaxDE.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
...
public abstract class SyntaxDE
{
    ...
    protected final void setContent(String st,int minsize,int maxsize)
    {
        ...
        if (len<minsize || (maxsize!=0 && len>maxsize)) {
            String msg=HBCIUtilsInternal.getLocMsg("EXC_DT_INV_STRINGLEN",new Object[] {
                                           st,Integer.toString(len),Integer.toString(minsize),Integer.toString(maxsize),this.getClass().getName()});
    ...
    */
    protected static int findNextDelim(StringBuffer res, int startidx)
    {
        int ret = startidx;
