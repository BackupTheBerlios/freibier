...
/*  $Id: SyntaxTime.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
     ...
     extends SyntaxDE
{
    ...
    {
        return new SimpleDateFormat("HHmmss").format(HBCIUtils.string2Time(x));
    }
    ...
    {
        try {
            return HBCIUtils.time2String(new SimpleDateFormat("HHmmss").parse(x));
        } catch (Exception e) {
