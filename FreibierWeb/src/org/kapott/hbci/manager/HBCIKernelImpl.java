...
/*  $Id: HBCIKernelImpl.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
...
public final class HBCIKernelImpl implements HBCIKernel
{
    ...
    public HBCIKernelImpl(String hbciversion)
    {
    ...
    public void rawNewMsg(String name)
    {
        ...
        currentMsgName=name;
        HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_NEWMSG",name),HBCIUtils.LOG_DEBUG2);
        gen.reset();
    }
    ...
    {
        HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_RAWSET",new Object[] {currentMsgName+"."+key,value}),
    ...
    public HBCIMsgStatus rawDoIt(HBCIPassportInternal passport,boolean signit,boolean cryptit,boolean needSig,boolean needCrypt)
    {
    ...
    public HBCIMsgStatus rawDoIt(HBCIPassportList passports,boolean signit,boolean cryptit,boolean needSig,boolean needCrypt)
    {
        ...
        try {
            ...
            HBCIUtils.log(HBCIUtilsInternal.getLocMsg("INFO_KRNL_GENMSG",currentMsgName),HBCIUtils.LOG_DEBUG);
            ...
            if (signit) {
                HBCIUtils.log(HBCIUtilsInternal.getLocMsg("INFO_KRNL_GENSIG"),HBCIUtils.LOG_DEBUG);
                ...
                Sig sig=SigFactory.getInstance().createSig(msg,gen,passports);
                try {
                    if (!sig.signIt()) {
            ...
            HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_SENDMSG")+": "+outstring,HBCIUtils.LOG_DEBUG2);
            ...
            if (cryptit) {
                HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_CRYPTIT"),HBCIUtils.LOG_DEBUG);
                HBCIUtilsInternal.getCallback().status(mainPassport,HBCICallback.STATUS_MSG_CRYPT,null);
                
                // nachricht verschlüsseln
                MSG   old=msg;
                Crypt crypt=CryptFactory.getInstance().createCrypt(old,gen,mainPassport);
                try {
                ...
                HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_CRYPTSEND")+": "+msg.toString(0),HBCIUtils.LOG_DEBUG2);
            }
            ...
            HBCIUtils.log(HBCIUtilsInternal.getLocMsg("INFO_KRNL_COMM",dialogid+"/"+msgnum),HBCIUtils.LOG_DEBUG);
            MSG old=msg;
            msg=mainPassport.getComm().pingpong(gen,currentMsgName,old);
            if (msg!=old) {
                MSGFactory.getInstance().unuseObject(old);
            }
            ...
            if (crypted) {
                ...
                Crypt  crypt=CryptFactory.getInstance().createCrypt(msg,gen,mainPassport);
                String newmsgstring;
                try {
            ...
            HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_RCVDMSG")+": "+msg.toString(0),HBCIUtils.LOG_DEBUG2);
            ...
            HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_EXDATA"),HBCIUtils.LOG_DEBUG);
            ...
            HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_CHKSIG"),HBCIUtils.LOG_DEBUG);
            ...
            HBCIUtils.log(HBCIUtilsInternal.getLocMsg("DBG_KRNL_CHKCRYPT"),HBCIUtils.LOG_DEBUG);
