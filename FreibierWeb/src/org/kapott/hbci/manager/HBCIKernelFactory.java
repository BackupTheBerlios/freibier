...
/*  $Id: HBCIKernelFactory.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
...
public class HBCIKernelFactory
{
    ...
    public static HBCIKernel getKernel(String hbciversion) 
    {
        return new HBCIKernelImpl(hbciversion);
    }
}
