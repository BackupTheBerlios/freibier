...
/*  $Id: DE.java,v 1.1 2005/04/05 21:34:48 tbayen Exp $
    ...
    extends SyntaxElement
{
    ...
    public boolean propagateValue(String destPath,String valueString,boolean tryToCreate,boolean allowOverwrite)
    {
        ...
        if (destPath.equals(getPath())) {
            if (value!=null) { // es gibt schon einen Wert
    ...
    public void validate()
    {
        ...
        if (validssize!=0) {
            boolean ok=false;
            String valString=(value!=null)?getValueOfDE(getPath()):"";

            for (int i=0;i<validssize;i++) {
                if (((String)(valids.get(i))).equals(valString)) 
                    ok=true;
            }
    ...
    private void parseValue(StringBuffer res,Hashtable predefs,Hashtable valids)
    {
        ...
        String predefined = (String)(predefs.get(getPath()));
        if (predefined!=null) {
        ...
        if (valids!=null) {
            ...
            for (Enumeration e=valids.keys();e.hasMoreElements();) {
                ...
                if (key.startsWith(header) && 
                    ...
                    atLeastOne=true;
                    String validValue=(String)(valids.get(key));
