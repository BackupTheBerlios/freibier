...
/* $Id: MultipleSEGsFactory.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
    ...
    extends ObjectFactory 
{
    ...
    {
        maxPoolSize=Integer.parseInt(HBCIUtils.getParam("kernel.objpool.SEG","128"));
    }
    
    public MultipleSEGs createMultipleSEGs(Node sfref, String path, char predelim0, char predelim1, StringBuffer res, int fullResLen, Document syntax, Hashtable predefs,Hashtable valids)
    {
        MultipleSEGs ret;
        ...
        if (freeObjects.isEmpty()) {
            ...
            ret=(MultipleSEGs)getFreeObject();
            try {
