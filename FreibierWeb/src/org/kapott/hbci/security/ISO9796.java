...
/*  $Id: ISO9796.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
    ...
    extends SignatureSpi
{
    ...
    protected boolean engineVerify(byte[] sig)
        throws SignatureException
    {
        BigInteger bExponent = pubKey.getPublicExponent();
        byte[] exponent = bExponent.toByteArray();
        BigInteger bModulus = pubKey.getModulus();
        byte[] modulus = bModulus.toByteArray();
