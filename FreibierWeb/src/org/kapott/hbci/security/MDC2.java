...
/*  $Id: MDC2.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
    ...
    extends java.security.MessageDigestSpi
{
    ...
    public MDC2()
    {
        try {
            ...
            throw new HBCI_Exception("can not init digest",e);
        }
    }
    ...
    protected byte[] engineDigest()
    {
        ...
        System.arraycopy(h1,0,ret,0,8);
        System.arraycopy(h2,0,ret,8,8);
    ...
    protected void engineReset()
    {
        ...
        Arrays.fill(h1,(byte)0x52);
        Arrays.fill(h2,(byte)0x25);
        writePos=0;
    }
    ...
    private void hashIt()
    {
        byte[] k1=g(h1,(byte)0x40);
        byte[] k2=g(h2,(byte)0x20);

        byte[] c1=xor(des(x,k1),x);
        byte[] c2=xor(des(x,k2),x);

        System.arraycopy(c1,0,h1,0,4);
        System.arraycopy(c2,4,h1,4,4);
        System.arraycopy(c2,0,h2,0,4);
        System.arraycopy(c1,4,h2,4,4);
    ...
    private byte[] des(byte[] data,byte[] keydata)
    {
        ...
        try { 
            ...
            throw new HBCI_Exception("error while DESing data",e);
        }
