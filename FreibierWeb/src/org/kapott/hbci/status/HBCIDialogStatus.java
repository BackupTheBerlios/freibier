...
/*  $Id: HBCIDialogStatus.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
...
public final class HBCIDialogStatus
{
    ...
    public Exception[] getExceptions()
    {
        ...
        if (initStatus!=null) {
            ret.addAll(new ArrayList(Arrays.asList(initStatus.getExceptions())));
        }
        
        if (msgStatus!=null) {
            for (int i=0;i<msgStatus.length;i++) {
                ret.addAll(new ArrayList(Arrays.asList(msgStatus[i].getExceptions())));
            }
        }
        
        if (endStatus!=null) {
            ret.addAll(new ArrayList(Arrays.asList(endStatus.getExceptions())));
        }

        return (Exception[])ret.toArray(new Exception[0]);
    }
    ...
    public String getErrorString()
    {
        ...
        if (initStatus!=null) {
            ...
            if (s.length()!=0) {
                ret.append(HBCIUtilsInternal.getLocMsg("STAT_INIT")+": ");
                ret.append(s);
                ret.append(System.getProperty("line.separator"));
            }
        } else {
            ret.append(HBCIUtilsInternal.getLocMsg("STAT_INIT")+": "+HBCIUtilsInternal.getLocMsg("STAT_NOTEXEC"));
            ret.append(System.getProperty("line.separator"));
        }
        ...
        if (msgStatus!=null) {
            for (int i=0;i<msgStatus.length;i++) {
                ...
                if (s.length()!=0) {
                    ret.append(HBCIUtilsInternal.getLocMsg("STAT_MSG")+" ");
        ...
        if (endStatus!=null) {
            ...
            if (s.length()!=0) {
                ret.append(HBCIUtilsInternal.getLocMsg("STAT_END")+": ");
                ret.append(s);
                ret.append(System.getProperty("line.separator"));
            }
        } else {
            ret.append(HBCIUtilsInternal.getLocMsg("STAT_END")+": "+HBCIUtilsInternal.getLocMsg("STAT_NOTEXEC"));
            ret.append(System.getProperty("line.separator"));
        }
    ...
    public String toString()
    {
        ...
        if (initStatus!=null) {
            ret.append(HBCIUtilsInternal.getLocMsg("STAT_INIT")+":"+System.getProperty("line.separator"));
        ...
        if (msgStatus!=null) {
            for (int i=0;i<msgStatus.length;i++) {
                ret.append(HBCIUtilsInternal.getLocMsg("STAT_MSG")+" #"+(i+1)+":"+System.getProperty("line.separator"));
        ...
        if (endStatus!=null) {
            ret.append(HBCIUtilsInternal.getLocMsg("STAT_END")+":"+System.getProperty("line.separator"));
