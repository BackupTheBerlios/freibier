...
/*  $Id: HBCIRetVal.java,v 1.1 2005/04/05 21:34:47 tbayen Exp $
    ...
    implements Serializable
{
    ...
    public String toString()
    {
        ...
        ret.append(segref).append(":").append(deref).append(": ").append(code).append(" - ").append(text);
        ...
        if (element!=null)
            ret.append(" (element ").append(element).append(")");
