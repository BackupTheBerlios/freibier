...
/*  $Id: HBCICallback.java,v 1.1 2005/04/05 21:34:48 tbayen Exp $
...
/** <p>Schnittstelle, die eine Callback-Klasse implementieren muss. Beim Initialisieren von <em>HBCI4Java</em> 
    ({@link org.kapott.hbci.manager.HBCIUtils#init(ClassLoader,String,org.kapott.hbci.callback.HBCICallback)})
...
public interface HBCICallback
{
    ...
    /** <p>Ursache des Callback-Aufrufes: Fehler beim Verifizieren einer Kontonummer mit Hilfe
        ...
        Aufträge 
        ({@link org.kapott.hbci.manager.HBCIHandler#addJob(org.kapott.hbci.GV.HBCIJob)})
    ...
    /** Kurzform für {@link #status(HBCIPassport, int, Object[])} mit nur
     *  einem zusätzlichen Objekt */
    public void status(HBCIPassport passport,int statusTag,Object o);
}
