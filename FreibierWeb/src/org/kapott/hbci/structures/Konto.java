...
/*  $Id: Konto.java,v 1.1 2005/04/05 21:34:46 tbayen Exp $
    ...
    implements Serializable
{
    ...
    /** Kreditinstitusseitiger Kundenname. Dieser Wert gibt an, unter
        ...
        {@link org.kapott.hbci.manager.HBCIHandler#addJob(String,org.kapott.hbci.GV.HBCIJob)} 
        ausgewertet werden. */
    ...
    /** Umwandeln der Kontoinformationen in einen String. Gibt einen String im
        folgenden Format zurück:
        <pre>[&lt;type> ": " ] [&lt;name> ": "] &lt;number> " BLZ " &lt;blz> "(" &lt;kiname> ")[" &lt;country> "]" [" " &lt;curr>]</pre>
        @return Stringdarstellung der Kontoverbindung */
    public String toString()
    {
        return ((type!=null)?type+" ":"")+
               ((name!=null)?name+" ":"")+
               number+" BLZ "+blz+"("+((blz!=null)?HBCIUtils.getNameForBLZ(blz):"")+")"+
               " (BIC "+(blz!=null?HBCIUtils.getBICForBLZ(blz):"")+")"+
               " ["+country+"]"+
               ((curr!=null)?" "+curr:"");
    }
