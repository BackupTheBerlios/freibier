...
<@page>
  ...
  <p>
  Mit dem roten Kreuz (<@icon name="bomb" title="löschen"/>) kann man Dateien
  aus dem Pool löschen, wenn diese sicher versandt sind und man keine Kopie
  mehr benötigt. Bei Problemen mit dem Versand per HBCI kann man die 
  DTAUS-Datei z.B. auf eine Diskette speichern, indem man auf das Symbol in 
  der Spalte "DTAUS" klickt.
  </p>
