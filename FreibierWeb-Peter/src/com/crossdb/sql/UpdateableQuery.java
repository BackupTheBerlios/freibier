...
public interface UpdateableQuery extends ExecuteUpdate
 {
    ...
    /*void addColumn(int column, String value);
	//void addColumn(String column, Integer value);
	void addColumn(int column, int value);
	void addColumn(int column, float value);
	void addColumn(int column, double value);
	void addColumn(int column, java.util.Date value);
	void addColumn(int column, boolean value);
*/
	/**
