...
public class BuchungslisteException extends XmlRpcTransactionException {

	private static final long serialVersionUID = 1164458226255L;
	...
	public BuchungslisteException(int code) {
		super((ErrorCode) errorCodesMap.get(new Integer(code)));
	}
	
	public BuchungslisteException(int code, Throwable ex) {
