...
public class BuchungszeileException extends XmlRpcTransactionException {

	private static final long serialVersionUID = 1143225537021L;
	...
	public BuchungszeileException(int code) {
		super((ErrorCode) errorCodesMap.get(new Integer(code)));
	}
	
	public BuchungszeileException(int code, Throwable ex) {
